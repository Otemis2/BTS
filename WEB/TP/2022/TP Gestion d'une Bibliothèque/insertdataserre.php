...
for($M=0;$M<60;$M=$M+15)
{
	...
	$requete="INSERT INTO `DonneesSerre` (`Date`, `Heure`, `Jour`, `TemperatureSerre`, `HygrometrieAir`, `HumiditeTerre`) VALUES ( '".$dategeneration."', '".$heure."', 'DIMANCHE', '".$temperature."', '".$Hygrometrie."', '".$humidite."');";
...
?>
	...
	<br>
	<br>
	<li><u><a href="./deletedataserre.php">deletedataserre.php :</a></u></li>
	<br>
</body>
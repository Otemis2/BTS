...
<?php
	...
	printf ( "<br>mon adresse IP est : <br>%s",$_SERVER["REMOTE_ADDR"]);
?>
...
?> 
<br><br>
<br><center><u>Partie 6 :</u></center><br>
<form action="traitement.php" method="GET">
	<p>
		Âge: <input type="text" name="age" > <br>
		École: <input type="text" name="ecole" >
		<input type="submit" value="Teddy" >
	</p>
</form>
<br><br>
<br><center><u>Partie 7 :</u></center><br>
<FORM ACTION="traitement.php" METHOD= "POST" >
Votre code d'usager: <INPUT TYPE="text" NAME="user" SIZE="8">
<BR>
Votre mot de passe: <INPUT TYPE="password" NAME="pass" SIZE="8">
<BR>
<INPUT TYPE="

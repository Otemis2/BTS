...
<?php	
	...
	$Serveur ="mysql-hucksylvain.alwaysdata.net";//Adresse du "serveur"
	$User = "220142_writer";//Utilisateur en écriture
	$Password = "2fpvb88S";//Mot de passe
	$Bdd = "hucksylvain_gestionstagiaires";//Base de donné a ciblé
